          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-indigo-500"
              />
            </div>
            ...
            <button
              ...
              className={`mt-4 w-full py-2 px-4 rounded-xl text-white bg-indigo-600 hover:bg-indigo-700 transition ${
